...
**Платформа AI-компаньонов для образовательных курсов**
...
- **Срок разработки:** 4-5 месяцев (16-20 недель)
- **Команда:** 7-8 человек (1-2 Frontend, 2 Backend, 2 ML/AI, 1 Дизайнер, 1 Продакт)
...
| Phase 1: Author Core | 3-6 | Auth, Course CRUD, File Upload, Graph Generation, Graph Editing |
| Phase 2: Diagnostics | 7-9 | Test Diagnostics, Case Diagnostics, Result Storage |
| Phase 3: Student Experience | 10-14 | Onboarding, Personalization, Navigation, Longread, Audio, Companion |
| Phase 4: Analytics & Polish | 15-18 | Progress Tracking, Teacher Dashboard, Bug fixes, UX improvements |

## 8.2 Распределение ролей

### Backend разработчики (2 человека)

- **Backend 1 (Senior):** Архитектура, API design, Core API, File upload, WebSocket
- **Backend 2 (Middle+):** Analytics, Groups, Diagnostic results, Background jobs

### ML/AI разработчики (2 человека)

- **ML/AI 1 (Senior):** RAG pipeline, Content personalization, Graph generation, Dialog context
- **ML/AI 2 (Middle+):** Document parsing, Diagnostic/case generation, TTS, Answer evaluation

### Frontend разработчики (1-2 человека)

- **Frontend 1 (Senior):** Архитектура, Auth flow, Course navigation, Graph viz, Chat interface
- **Frontend 2 (Middle):** Content editors, Diagnostic UI, Audio player, Analytics dashboards

### Дизайнер и Продакт

- **Дизайнер:** Design system, Author/Student flows, Avatar и эмоции, Responsive
- **Продакт:** Приоритизация, User stories, Тестирование, Документация
